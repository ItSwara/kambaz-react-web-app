...
// import { addAssignment as addAssignmentToState, deleteAssignment as deleteAssignmentFromState } from "./reducer";
// import AssignmentCreator from "./NewEditor";
// import { Modal } from "react-bootstrap";
// import AssignmentControlButtons from "./AssignControlButtons";
// import { setAssignments, findAssignmentsForCourse, deleteAssignment as deleteAssignmentAPI } from "./client";
...
//     // Fetch assignments for the course when the component mounts or courseId changes
//     useEffect(() => {
//         if (cid) {
//             const fetchAssignments = async () => {
//                 const assignmentsData = await findAssignmentsForCourse(cid);
//                 assignmentsData.forEach((assignment: any) => {
//                     dispatch(addAssignmentToState(assignment));  // Add fetched assignments to state
//                 });
//             };
...
//         if (cid) {
//             try {
//                 const newAssignment = await createAssignment(cid, assignment);  // Create the assignment via the API
//                 console.log(newAssignment);
//                 dispatch(addAssignmentToState(newAssignment));  // Dispatch the new assignment to Redux
//                 handleClose();  // Close the modal after creating the assignment
//             } catch (error) {
//                 console.error("Error creating assignment:", error);
//             }
//         }
...
//         await deleteAssignmentAPI(assignmentId);  // Remove from API
//         dispatch(deleteAssignmentFromState(assignmentId));  // Remove from Redux state
//     };
...
// import { Modal } from "react-bootstrap";
// import AssignmentControlButtons from "./AssignControlButtons";
// import { createAssignment, findAssignmentsForCourse, deleteAssignment as deleteAssignmentAPI } from "./client";
